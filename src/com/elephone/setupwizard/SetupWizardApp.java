...
public class SetupWizardApp extends Application {
    ...
    public static final String ACTION_FINISHED = "com.elephone.setupwizard.SETUP_FINISHED";
    ...
    public static final String INTENT_EXTRA1 = "verify_unlock";
    public static final String INTENT_EXTRA2 = "minimum_quality";
    public static final String INTENT_EXTRA3 = "hide_disabled_prefs";
    ...
    public static final int INPUT_OR_CONFORM_PWD_ID = 1;
