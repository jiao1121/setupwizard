...
public class ChooseDataSimActivity extends BaseSetupWizardActivity {
    ...
    private ViewGroup mPageFrameView;
            ...
            new PhoneMonitor.SubscriptionStateListener() {
                ...
                public void onServiceStateChanged(int subId, ServiceState serviceState) {
                    ...
                    if (subInfoRecord != null) {
                        ...
                        mServiceStates.put(PhoneMonitor.getInstance().getActiveSubscriptionInfo(subId).getSimSlotIndex(), serviceState);
                    }
                    updateSignalStrength(subInfoRecord);
                    if (SetupWizardUtils.isRadioReady(ChooseDataSimActivity.this, serviceState)) {
                        hideWaitForRadio();
                    }
                ...
                public void onSignalStrengthsChanged(int subId, SignalStrength signalStrength) {
                    ...
                    if (subInfoRecord != null) {
                        ...
                        mSignalStrengths.put(PhoneMonitor.getInstance().getActiveSubscriptionInfo(subId).getSimSlotIndex(), signalStrength);
                    }
                    updateSignalStrength(subInfoRecord);
                }
    ...
    private View.OnClickListener mEnableDataClickListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            SetupWizardUtils.setMobileDataEnabled(ChooseDataSimActivity.this, checked);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPageFrameView = (ViewGroup) findViewById(R.id.frame_view);
        ...
        mDataSummary = (TextView) findViewById(R.id.data_summary);
        updateDataConnectionStatus();
        List<SubscriptionInfo> subInfoRecords = mPhoneMonitor.getActiveSubscriptionInfoList();
        int simCount = subInfoRecords != null ? subInfoRecords.size() : 0;
    ...
    private void showPage() {
        ...
        mPageFrameView.setVisibility(View.VISIBLE);
        mDataSummary.setVisibility(View.VISIBLE);
        mEnableDataRow.setVisibility(View.VISIBLE);
...
/* Think:jiaozhihao on: Wed, 21 Mar 2018 14:04:30 +0800
 ...
 */
            if (subInfoRecord.getSimSlotIndex() == 0) {
                signalView.setImageResource(R.drawable.ic_sim1);
            } else if (subInfoRecord.getSimSlotIndex() == 1) {
                signalView.setImageResource(R.drawable.ic_sim2);
            }
